...
public class MidiToSynthSequence {
  public String songName = "src/Purgatory/pvz";
  ...
  public static void main(String[] args) throws IOException {
    MidiToSynthSequence mtss = new MidiToSynthSequence();
    mtss.run();
  }
      ...
      for (int i = 0; i < track.size(); i++) {
        ...
        if (message instanceof ShortMessage) {
          ...
          if (cmd == ShortMessage.NOTE_OFF || (cmd == ShortMessage.NOTE_ON && velocity == 0)) {
            ...
            out.println("- " + currentTime + " " + eventID);
          }
            ...
            out.println("+ " + currentTime + " " + eventID + " " + sineEnvParams);
          }
        }
